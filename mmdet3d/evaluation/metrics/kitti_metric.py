...
class KittiMetric(BaseMetric):
    ...
    def kitti_evaluate(self,
        ...
        if constants.sample_method != 'none':
            self.write_to_file(ap_dict, constants.sample_method, constants.sample_rate, constants.model_name, constants.feature_model)
    ...
    def write_to_file(self, result_dict, sample_method = '', sample_rate = '', model_name = '', feature_model = '', time = ''):
        ...
        sheet.cell(row=row, column=column_index_from_string('C')).value = result_dict['pred_instances_3d/KITTI/Car_3D_AP40_easy_strict']
        sheet.cell(row=row, column=column_index_from_string('D')).value = result_dict['pred_instances_3d/KITTI/Car_3D_AP40_moderate_strict']
        sheet.cell(row=row, column=column_index_from_string('E')).value = result_dict['pred_instances_3d/KITTI/Car_3D_AP40_hard_strict']

        sheet.cell(row=row, column=column_index_from_string('F')).value = result_dict['pred_instances_3d/KITTI/Pedestrian_3D_AP40_easy_strict']
        sheet.cell(row=row, column=column_index_from_string('G')).value = result_dict['pred_instances_3d/KITTI/Pedestrian_3D_AP40_moderate_strict']
        sheet.cell(row=row, column=column_index_from_string('H')).value = result_dict['pred_instances_3d/KITTI/Pedestrian_3D_AP40_hard_strict']

        sheet.cell(row=row, column=column_index_from_string('I')).value = result_dict['pred_instances_3d/KITTI/Cyclist_3D_AP40_easy_strict']
        sheet.cell(row=row, column=column_index_from_string('J')).value = result_dict['pred_instances_3d/KITTI/Cyclist_3D_AP40_moderate_strict']
        sheet.cell(row=row, column=column_index_from_string('K')).value = result_dict['pred_instances_3d/KITTI/Cyclist_3D_AP40_hard_strict']

        sheet.cell(row=row, column=column_index_from_string('M')).value = result_dict['pred_instances_3d/KITTI/Overall_3D_AP40_easy']
        sheet.cell(row=row, column=column_index_from_string('N')).value = result_dict['pred_instances_3d/KITTI/Overall_3D_AP40_moderate']
        sheet.cell(row=row, column=column_index_from_string('O')).value = result_dict['pred_instances_3d/KITTI/Overall_3D_AP40_hard']
