...
class WaymoMetric(KittiMetric):
    ...
    def compute_metrics(self, results: List[dict]) -> Dict[str, float]:
        ...
        self.pklfile_prefix = '/home/xiaoyu/experiments/mmdetection3d/tools/waymo_results'
    ...
    def waymo_evaluate(self,
        ...
        self.waymo_bin_file = '/data/waymo/waymo_format/gt_subset.bin'
        if metric == 'mAP':
            eval_str = '~/experiments/mmdetection3d/mmdet3d/evaluation/functional/waymo_utils/' + \
